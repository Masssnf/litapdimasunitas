...
@section('header', 'Tambah Bidang Penelitian')
    ...
    <div class="space-y-5">
        ...
        <div
            ...
            <div class="relative flex flex-wrap justify-between items-center gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white tracking-tight">Tambah Bidang Penelitian</h1>
                        <div class="flex items-center space-x-3 mt-0.5">
                            <span class="text-blue-100 text-sm">Tambahkan data bidang penelitian baru</span>
                        </div>
                    </div>
                </div>
        ...
        <div
            ...
            <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-gray-700">Form Bidang Penelitian</h3>
                    <p class="text-xs text-gray-400">Lengkapi data bidang penelitian di bawah ini</p>
                </div>
            </div>

            <form action="{{ route('admin.bidangpenelitian.store') }}" method="POST" class="p-6">
                @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="kode_bidang" id="kode_bidang" value="{{ old('kode_bidang') }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition @error('kode_bidang') border-rose-500 focus:ring-rose-500 @enderror"
                                placeholder="Contoh: BD-001" required>
                        </div>
                        @error('kode_bidang')
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_bidang" id="nama_bidang" value="{{ old('nama_bidang') }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition @error('nama_bidang') border-rose-500 focus:ring-rose-500 @enderror"
                                placeholder="Contoh: Pendidikan Karakter" required>
                        </div>
                        @error('nama_bidang')
                            <p class="mt-1 text-sm text-rose-600 flex items-center gap-1">
                                <i class="fas fa-exclamation-circle"></i> {{ $message }}
                ...
                <div class="mt-4">
                    ...
                    <div class="relative">
                        ...
                        <textarea name="deskripsi_bidang" id="deskripsi_bidang" rows="3"
                            class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition @error('deskripsi_bidang') border-rose-500 focus:ring-rose-500 @enderror"
                            placeholder="Masukkan deskripsi bidang penelitian">{{ old('deskripsi_bidang') }}</textarea>
                    </div>
                ...
                <div class="mt-4">
                    ...
                    <select name="status_bidang" id="status_bidang" class="select2 w-full" data-placeholder="Pilih Status"
                        data-allow-clear="false" data-search="-1" required>
                        <option value="1" {{ old('status_bidang') == '1' ? 'selected' : '' }}>✅ Aktif</option>
                        <option value="0" {{ old('status_bidang') == '0' ? 'selected' : '' }}>❌ Nonaktif</option>
                    </select>
                    @error('status_bidang')
                        <p class="mt-1 text-sm text-rose-600 flex items-center gap-1">
                            <i class="fas fa-exclamation-circle"></i> {{ $message }}
