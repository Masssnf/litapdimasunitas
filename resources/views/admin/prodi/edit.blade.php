        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <i class="fas fa-chevron-right text-gray-400 text-xs"></i>
                        <span class="ml-1 text-sm font-medium text-gray-700">Edit Program Studi</span>
                    </div>
                </li>
            </ol>
        </nav>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <select name="jenjang_prodi" id="jenjang_prodi" class="select2 w-full"
                            data-placeholder="Pilih Jenjang" data-allow-clear="false" data-search="-1" required>
                            <option value="S1"
                                {{ old('jenjang_prodi', $prodi->jenjang_prodi) == 'S1' ? 'selected' : '' }}>S1</option>
                            <option value="S2"
                                {{ old('jenjang_prodi', $prodi->jenjang_prodi) == 'S2' ? 'selected' : '' }}>S2</option>
                            <option value="S3"
                                {{ old('jenjang_prodi', $prodi->jenjang_prodi) == 'S3' ? 'selected' : '' }}>S3</option>
                            <option value="Profesi"
                                {{ old('jenjang_prodi', $prodi->jenjang_prodi) == 'Profesi' ? 'selected' : '' }}>Profesi
                            </option>
                        </select>
                        @error('jenjang_prodi')
                            <p class="mt-1 text-sm text-rose-600 flex items-center gap-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    ...
                    <div>
                        ...
                        <select name="status_prodi" id="status_prodi" class="select2 w-full"
                            ...
                            <option value="1" {{ old('status_prodi', $prodi->status_prodi) == 1 ? 'selected' : '' }}>
                                Aktif</option>
                            <option value="0" {{ old('status_prodi', $prodi->status_prodi) == 0 ? 'selected' : '' }}>
                                Nonaktif</option>
                        </select>
                        @error('status_prodi')
                            <p class="mt-1 text-sm text-rose-600 flex items-center gap-1">
