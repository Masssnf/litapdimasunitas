...
@section('header', 'Tambah Periode Skema')
    ...
    <div class="space-y-5">
        ...
        <div
            ...
            <div class="relative flex flex-wrap justify-between items-center gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white tracking-tight">Tambah Periode Skema</h1>
                        <div class="flex items-center space-x-3 mt-0.5">
                            <span class="text-rose-100 text-sm">Tambahkan data periode skema baru</span>
                        </div>
                    </div>
                </div>
        ...
        <div
            ...
            <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-gray-700">Form Periode Skema</h3>
                    <p class="text-xs text-gray-400">Lengkapi data periode skema di bawah ini</p>
                </div>
            </div>

            <form action="{{ route('admin.periodeskema.store') }}" method="POST" class="p-6">
                @csrf
                            ...
                            <select name="periode_id" id="periode_id"
                                ...
                                @foreach ($periode as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('periode_id') == $item->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="skema_id" id="skema_id"
                                ...
                                data-placeholder="Pilih Skema" required>
                                <option value="">Pilih Skema</option>
                                @foreach ($skema as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('skema_id') == $item->id ? 'selected' : '' }}>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="tanggal_mulai_pengajuan" id="tanggal_mulai_pengajuan"
                                value="{{ old('tanggal_mulai_pengajuan') }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition @error('tanggal_mulai_pengajuan') border-rose-500 focus:ring-rose-500 @enderror"
                                required>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="tanggal_selesai_pengajuan" id="tanggal_selesai_pengajuan"
                                value="{{ old('tanggal_selesai_pengajuan') }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition @error('tanggal_selesai_pengajuan') border-rose-500 focus:ring-rose-500 @enderror"
                                required>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="tanggal_mulai_review" id="tanggal_mulai_review"
                                value="{{ old('tanggal_mulai_review') }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition @error('tanggal_mulai_review') border-rose-500 focus:ring-rose-500 @enderror">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="tanggal_selesai_review" id="tanggal_selesai_review"
                                value="{{ old('tanggal_selesai_review') }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition @error('tanggal_selesai_review') border-rose-500 focus:ring-rose-500 @enderror">
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="tanggal_pengumuman" id="tanggal_pengumuman"
                                ...
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition @error('tanggal_pengumuman') border-rose-500 focus:ring-rose-500 @enderror">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="kuota_proposal" id="kuota_proposal"
                                value="{{ old('kuota_proposal', 1) }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition @error('kuota_proposal') border-rose-500 focus:ring-rose-500 @enderror"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="dana_minimal" id="dana_minimal"
                                value="{{ old('dana_minimal', 0) }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition @error('dana_minimal') border-rose-500 focus:ring-rose-500 @enderror"
                                placeholder="Contoh: 1000000" min="0" step="1000" required>
                        </div>
                        @error('dana_minimal')
                            <p class="mt-1 text-sm text-rose-600 flex items-center gap-1">
                                <i class="fas fa-exclamation-circle"></i> {{ $message }}
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="dana_maksimal" id="dana_maksimal"
                                value="{{ old('dana_maksimal', 0) }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition @error('dana_maksimal') border-rose-500 focus:ring-rose-500 @enderror"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="maksimal_anggota" id="maksimal_anggota"
                                value="{{ old('maksimal_anggota', 1) }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition @error('maksimal_anggota') border-rose-500 focus:ring-rose-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="luaran_wajib" id="luaran_wajib"
                                value="{{ old('luaran_wajib') }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition @error('luaran_wajib') border-rose-500 focus:ring-rose-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="keterangan" id="keterangan" value="{{ old('keterangan') }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition @error('keterangan') border-rose-500 focus:ring-rose-500 @enderror"
                ...
                <div class="mt-6 pt-4 border-t border-gray-100 flex flex-wrap justify-end gap-3">
                    ...
                    <button type="submit"
                        class="px-6 py-2.5 bg-gradient-to-r from-rose-500 to-pink-500 text-white rounded-xl hover:from-rose-600 hover:to-pink-600 transition-all duration-200 shadow-md shadow-rose-500/25 hover:shadow-lg hover:shadow-rose-500/30 text-sm font-medium">
                        <i class="fas fa-save mr-2"></i>
                        Simpan Periode Skema
                    </button>
                </div>
            </form>
        </div>
