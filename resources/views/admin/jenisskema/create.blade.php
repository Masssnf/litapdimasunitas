...
@section('header', 'Tambah Jenis Skema')
    ...
    <div class="space-y-5">
        ...
        <div
            ...
            <div class="relative flex flex-wrap justify-between items-center gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white tracking-tight">Tambah Jenis Skema</h1>
                        <div class="flex items-center space-x-3 mt-0.5">
                            <span class="text-blue-100 text-sm">Tambahkan data jenis skema baru</span>
                        </div>
                    </div>
                </div>
        ...
        <div
            ...
            <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-gray-700">Form Jenis Skema</h3>
                    <p class="text-xs text-gray-400">Lengkapi data jenis skema di bawah ini</p>
                </div>
            </div>

            <form action="{{ route('admin.jenisskema.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="kode_jenisskema" id="kode_jenisskema"
                                value="{{ old('kode_jenisskema') }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition @error('kode_jenisskema') border-rose-500 focus:ring-rose-500 @enderror"
                                placeholder="Contoh: SK-001" required>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_jenisskema" id="nama_jenisskema"
                                value="{{ old('nama_jenisskema') }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition @error('nama_jenisskema') border-rose-500 focus:ring-rose-500 @enderror"
                ...
                <div class="mt-4">
                    ...
                    <div class="relative">
                        ...
                        <textarea name="deskripsi_jenisskema" id="deskripsi_jenisskema" rows="3"
                            class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition @error('deskripsi_jenisskema') border-rose-500 focus:ring-rose-500 @enderror"
                            placeholder="Masukkan deskripsi jenis skema">{{ old('deskripsi_jenisskema') }}</textarea>
                    </div>
                ...
                <div class="mt-4">
                    ...
                    <select name="status_jenisskema" id="status_jenisskema" class="select2 w-full"
                        data-placeholder="Pilih Status" data-allow-clear="false" data-search="-1" required>
                        <option value="1" {{ old('status_jenisskema') == '1' ? 'selected' : '' }}>✅ Aktif</option>
                        <option value="0" {{ old('status_jenisskema') == '0' ? 'selected' : '' }}>❌ Nonaktif</option>
                    </select>
                ...
                <div class="mt-6 pt-4 border-t border-gray-100 flex flex-wrap justify-end gap-3">
                    ...
                    <button type="submit"
                        class="px-6 py-2.5 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-xl hover:from-blue-600 hover:to-indigo-600 transition-all duration-200 shadow-md shadow-blue-500/25 hover:shadow-lg hover:shadow-blue-500/30 text-sm font-medium">
