...
@section('header', 'Tambah Jenis Reviewer')
...
<div class="space-y-5">
    ...
    <!-- HERO HEADER                                   -->
    <!-- ============================================= -->
    <div class="relative overflow-hidden bg-gradient-to-br from-purple-600 via-purple-500 to-pink-600 rounded-2xl shadow-xl shadow-purple-500/20 p-6">
        ...
        <div class="relative flex flex-wrap justify-between items-center gap-4">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-white tracking-tight">Tambah Jenis Reviewer</h1>
                    <div class="flex items-center space-x-3 mt-0.5">
                        <span class="text-purple-100 text-sm">Tambahkan data jenis reviewer baru</span>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100/80 overflow-hidden transition-all hover:shadow-md">
        ...
        <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
            ...
            <div>
                <h3 class="text-sm font-semibold text-gray-700">Form Jenis Reviewer</h3>
                <p class="text-xs text-gray-400">Lengkapi data jenis reviewer di bawah ini</p>
            </div>
        </div>

        <form action="{{ route('admin.jenisreviewer.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   name="kode_jenisreviewer" 
                                   id="kode_jenisreviewer"
                                   value="{{ old('kode_jenisreviewer') }}"
                                   class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition @error('kode_jenisreviewer') border-rose-500 focus:ring-rose-500 @enderror"
                                   placeholder="Contoh: JR-001" 
                                   required>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   name="nama_jenisreviewer" 
                                   id="nama_jenisreviewer"
                                   value="{{ old('nama_jenisreviewer') }}"
                                   class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition @error('nama_jenisreviewer') border-rose-500 focus:ring-rose-500 @enderror"
                                   placeholder="Contoh: Reviewer Internal" 
                                   required>
                        </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <select name="status_jenisreviewer" 
                                id="status_jenisreviewer"
                                class="select2 w-full"
                                data-placeholder="Pilih Status"
                                data-allow-clear="false"
                                data-search="-1"
                                required>
                            <option value="1" {{ old('status_jenisreviewer') == '1' ? 'selected' : '' }}>✅ Aktif</option>
                            <option value="0" {{ old('status_jenisreviewer') == '0' ? 'selected' : '' }}>❌ Nonaktif</option>
                        </select>
