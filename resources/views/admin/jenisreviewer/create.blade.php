    ...
    <div class="space-y-5">
        ...
        <div
            ...
            <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-gray-700">Form Data Jenis Reviewer</h3>
            ...
            <form action="{{ route('admin.jenisreviewer.store') }}" method="POST" class="p-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="kode_jenisreviewer" id="kode_jenisreviewer"
                                ...
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition @error('kode_jenisreviewer') border-rose-500 focus:ring-rose-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_jenisreviewer" id="nama_jenisreviewer"
                                ...
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition @error('nama_jenisreviewer') border-rose-500 focus:ring-rose-500 @enderror"
                ...
                <div class="mt-4">
                    ...
                    <select name="status_jenisreviewer" id="status_jenisreviewer" class="select2 w-full"
                        ...
                        <option value="1" {{ old('status_jenisreviewer') == '1' ? 'selected' : '' }}>✅ Aktif
                        </option>
                        <option value="0" {{ old('status_jenisreviewer') == '0' ? 'selected' : '' }}>❌ Nonaktif
                        </option>
                    </select>
