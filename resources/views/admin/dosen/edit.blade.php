    ...
    <div class="space-y-5">
        ...
        <div
            ...
            <div class="relative flex flex-wrap justify-between items-center gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white tracking-tight">Edit Dosen</h1>
                        <div class="flex items-center space-x-3 mt-0.5">
                            <span class="text-amber-100 text-sm">Ubah informasi data dosen</span>
                            <span
        ...
        <div
            ...
            <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-gray-700">Form Edit Dosen</h3>
                    <p class="text-xs text-gray-400">Ubah data dosen di bawah ini</p>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nidn" id="nidn" value="{{ old('nidn', $dosen->nidn) }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('nidn') border-rose-500 focus:ring-rose-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_dosen" id="nama_dosen"
                                ...
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('nama_dosen') border-rose-500 focus:ring-rose-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email_dosen" id="email_dosen"
                                ...
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('email_dosen') border-rose-500 focus:ring-rose-500 @enderror"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="notelp_dosen" id="notelp_dosen"
                                value="{{ old('notelp_dosen', $dosen->notelp_dosen) }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('notelp_dosen') border-rose-500 focus:ring-rose-500 @enderror"
                    ...
                    <div>
                        ...
                        <select name="status_dosen" id="status_dosen" class="select2 w-full"
                            data-placeholder="Pilih Status" data-allow-clear="false" data-search="-1" required>
                            <option value="1" {{ old('status_dosen', $dosen->status_dosen) == 1 ? 'selected' : '' }}>
                                ✅ Aktif</option>
                            <option value="0" {{ old('status_dosen', $dosen->status_dosen) == 0 ? 'selected' : '' }}>
                                ❌ Nonaktif</option>
                        </select>
                        @error('status_dosen')
                            <p class="mt-1 text-sm text-rose-600 flex items-center gap-1">
                ...
                <div class="mt-4">
                    ...
                    <div class="relative">
                        ...
                        <textarea name="alamat_dosen" id="alamat_dosen" rows="3"
                            class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('alamat_dosen') border-rose-500 focus:ring-rose-500 @enderror"
                            placeholder="Masukkan alamat lengkap dosen">{{ old('alamat_dosen', $dosen->alamat_dosen) }}</textarea>
                    </div>
                    @error('alamat_dosen')
                        <p class="mt-1 text-sm text-rose-600 flex items-center gap-1">
                            <i class="fas fa-exclamation-circle"></i> {{ $message }}
