        ...
        <div
            ...
            <div class="relative flex flex-wrap justify-between items-center gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white tracking-tight">Detail Skema</h1>
                        <div class="flex items-center space-x-3 mt-0.5">
                            <span class="text-purple-100 text-sm">Informasi lengkap data skema</span>
                            <span
            ...
            <div class="lg:col-span-2 space-y-5">
                <div
                    ...
                    <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-sm font-semibold text-gray-700">Data Skema</h3>
                            <p class="text-xs text-gray-400">Informasi lengkap skema</p>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="bg-gray-50/50 rounded-xl p-4">
                                <p class="text-xs text-gray-400 font-medium uppercase tracking-wider">Kode Skema</p>
                                <p class="text-base font-semibold text-gray-800 mt-1 font-mono">{{ $skema->kode_skema }}</p>
                            </div>

                            <div class="bg-gray-50/50 rounded-xl p-4">
                                <p class="text-xs text-gray-400 font-medium uppercase tracking-wider">Nama Skema</p>
                                <p class="text-base font-semibold text-gray-800 mt-1">{{ $skema->nama_skema }}</p>
                            </div>

                            <div class="bg-gray-50/50 rounded-xl p-4">
                                <p class="text-xs text-gray-400 font-medium uppercase tracking-wider">Jenis Skema</p>
                                <p class="text-base font-semibold text-gray-800 mt-1 flex items-center gap-2">
                                    <i class="fas fa-tags text-purple-500 text-sm"></i>
                                    {{ $skema->jenisskema->nama_jenisskema ?? '-' }}
                                </p>
                            </div>
                            ...
                            <div class="bg-gray-50/50 rounded-xl p-4">
                                <p class="text-xs text-gray-400 font-medium uppercase tracking-wider">Dana Minimal</p>
                                <p class="text-base font-semibold text-gray-800 mt-1 flex items-center gap-2">
                                    <i class="fas fa-money-bill-wave text-purple-500 text-sm"></i>
                                    Rp {{ number_format($skema->dana_minimalskema ?? 0, 0, ',', '.') }}
                                </p>
                            </div>

                            <div class="bg-gray-50/50 rounded-xl p-4">
                                <p class="text-xs text-gray-400 font-medium uppercase tracking-wider">Dana Maksimal</p>
                                <p class="text-base font-semibold text-gray-800 mt-1 flex items-center gap-2">
                                    <i class="fas fa-money-bill-wave text-purple-500 text-sm"></i>
                                    Rp {{ number_format($skema->dana_maksimalskema ?? 0, 0, ',', '.') }}
                                </p>
                            </div>
                            ...
                            <div class="md:col-span-2 bg-gray-50/50 rounded-xl p-4">
                                ...
                                <p class="text-base font-semibold text-gray-800 mt-1">{{ $skema->deskripsi_skema ?? '-' }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="p-6 space-y-4">
                        <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4">
                            <div class="space-y-3">
                                <div>
                                    <p class="text-xs text-gray-500 font-medium">Jenis Skema</p>
                                    <p class="text-lg font-bold text-purple-600 mt-0.5">
                                        {{ $skema->jenisskema->nama_jenisskema ?? '-' }}</p>
                                    <p class="text-xs text-gray-400">{{ $skema->jenisskema->kode_jenisskema ?? '-' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50/50 rounded-xl p-4 space-y-2">
                            <div class="flex justify-between text-sm">
                                ...
                                <span
                                    class="text-gray-700 font-medium">{{ $skema->created_at->format('d-m-Y H:i') }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Terakhir diubah</span>
                                <span
                                    class="text-gray-700 font-medium">{{ $skema->updated_at->format('d-m-Y H:i') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400">Kelola data skema</p>
                        </div>
                    </div>
                    ...
                    <div class="p-4 space-y-2">
                        <a href="{{ route('admin.skema.edit', $skema->id) }}"
                            ...
                            <span class="text-sm font-medium">Edit Data Skema</span>
                        </a>
                        <a href="{{ route('admin.jenisskema.show', $skema->jenisskema_id) }}"
                            ...
                            <span class="text-sm font-medium">Lihat Jenis Skema</span>
                        </a>
                        <form action="{{ route('admin.skema.destroy', $skema->id) }}" method="POST" class="w-full"
                            onsubmit="return confirmDelete(this, '{{ $skema->nama_skema }}')">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
                                ...
                                <span class="text-sm font-medium">Hapus Skema</span>
                            </button>
                        </form>
                    </div>
                </div>
