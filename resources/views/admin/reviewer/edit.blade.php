    ...
    <div class="space-y-5">
        ...
        <div
            ...
            <div class="relative flex flex-wrap justify-between items-center gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white tracking-tight">Edit Reviewer</h1>
                        <div class="flex items-center space-x-3 mt-0.5">
                            <span class="text-amber-100 text-sm">Ubah informasi data reviewer</span>
                            <span
        ...
        <div
            ...
            <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-gray-700">Form Edit Reviewer</h3>
                    <p class="text-xs text-gray-400">Ubah data reviewer di bawah ini</p>
                </div>
            </div>

            <form action="{{ route('admin.reviewer.update', $reviewer->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')

                <!-- ============================================= -->
                <!-- BARIS 1: Kode & Nama Reviewer                 -->
                <!-- ============================================= -->
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="kode_reviewer" id="kode_reviewer"
                                ...
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('kode_reviewer') border-rose-500 focus:ring-rose-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_reviewer" id="nama_reviewer"
                                value="{{ old('nama_reviewer', $reviewer->nama_reviewer) }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('nama_reviewer') border-rose-500 focus:ring-rose-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nidn_reviewer" id="nidn_reviewer"
                                ...
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('nidn_reviewer') border-rose-500 focus:ring-rose-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="instansi_reviewer" id="instansi_reviewer"
                                ...
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('instansi_reviewer') border-rose-500 focus:ring-rose-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email_reviewer" id="email_reviewer"
                                value="{{ old('email_reviewer', $reviewer->email_reviewer) }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('email_reviewer') border-rose-500 focus:ring-rose-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="notelp_reviewer" id="notelp_reviewer"
                                ...
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('notelp_reviewer') border-rose-500 focus:ring-rose-500 @enderror"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <select name="status_reviewer" id="status_reviewer" class="select2 w-full"
                            ...
                            <option value="1"
                                {{ old('status_reviewer', $reviewer->status_reviewer) == 1 ? 'selected' : '' }}>✅ Aktif
                            </option>
                            <option value="0"
                                {{ old('status_reviewer', $reviewer->status_reviewer) == 0 ? 'selected' : '' }}>❌ Nonaktif
                            </option>
                        </select>
                        ...
                        <div class="relative">
                            ...
                            <select name="dosen_id" id="dosen_id"
                                ...
                                @foreach ($dosen as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('dosen_id', $reviewer->dosen_id) == $item->id ? 'selected' : '' }}>
                ...
                <div class="mt-4">
                    ...
                    <div class="relative">
                        ...
                        <textarea name="alamat_reviewer" id="alamat_reviewer" rows="3"
                            class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('alamat_reviewer') border-rose-500 focus:ring-rose-500 @enderror"
                            placeholder="Masukkan alamat lengkap reviewer">{{ old('alamat_reviewer', $reviewer->alamat_reviewer) }}</textarea>
                    </div>
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            // Inisialisasi Select2 untuk Jenis Reviewer
            $('#jenisreviewer_id').select2({
                placeholder: 'Pilih Jenis Reviewer',
                allowClear: false,
                width: '100%'
            });
