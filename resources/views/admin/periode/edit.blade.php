    ...
    <div class="space-y-5">
        ...
        <div
            ...
            <div class="relative flex flex-wrap justify-between items-center gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white tracking-tight">Edit Periode</h1>
                        <div class="flex items-center space-x-3 mt-0.5">
                            <span class="text-amber-100 text-sm">Ubah informasi data periode</span>
                            <span
        ...
        <div
            ...
            <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-gray-700">Form Edit Periode</h3>
                    <p class="text-xs text-gray-400">Ubah data periode di bawah ini</p>
                </div>
            </div>

            <form action="{{ route('admin.periode.update', $periode->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="kode_periode" id="kode_periode"
                                ...
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('kode_periode') border-rose-500 focus:ring-rose-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_periode" id="nama_periode"
                                ...
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('nama_periode') border-rose-500 focus:ring-rose-500 @enderror"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <select name="semester" id="semester" class="select2 w-full" data-placeholder="Pilih Jenjang"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="tahun_anggaran" id="tahun_anggaran"
                                ...
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('tahun_anggaran') border-rose-500 @enderror"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <select name="status_periode" id="status_periode" class="select2 w-full"
                            ...
                            <option value="1"
                                {{ old('status_periode', $periode->status_periode) == 1 ? 'selected' : '' }}>✅ Aktif
                            </option>
                            <option value="0"
                                {{ old('status_periode', $periode->status_periode) == 0 ? 'selected' : '' }}>❌ Nonaktif
                            </option>
                        </select>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="keterangan_periode" id="keterangan_periode"
                                value="{{ old('keterangan_periode', $periode->keterangan_periode) }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition @error('keterangan_periode') border-rose-500 focus:ring-rose-500 @enderror"
